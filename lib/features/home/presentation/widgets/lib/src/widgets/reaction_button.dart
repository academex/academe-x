import 'package:academe_x/features/home/presentation/widgets/lib/src/enums/reaction.dart';
import 'package:academe_x/features/home/presentation/widgets/lib/src/extensions/key.dart';
import 'package:academe_x/features/home/presentation/widgets/lib/src/widgets/reactions_box.dart';
...
class ReactionButton<T> extends StatefulWidget {
  ...
  const ReactionButton({
    ...
    this.child,
    this.direction = ReactionsBoxAlignment.ltr, required placeHolder,
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onLongPressStart: (details) {
        if (widget.toggle) {
          _onShowReactionsBox(_isContainer ? details.localPosition: null);
        }
      },
      child: child,
    );
      ...
      builder: (context) {
        return ReactionsBox<T>(
          ...
          onReactionSelected: (reaction) {
            _updateReaction(reaction as Reaction<T>?);
            _disposeOverlayEntry();
          },
          onClose: () {
            _disposeOverlayEntry();
