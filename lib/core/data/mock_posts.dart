...
class MockData {
  static final List<PostEntity> posts = [
    PostEntity(
      ...
      timeAgo: 'الان',
      content: 'مرحبا كيف الحال اليوم جبتلكم ملفات مهمة,مرحبا كيف الحال اليوم جبتلكم ملفات مهمةمرحبا كيف الحال اليوم جبتلكم ملفات مهمةمرحبا كيف الحال اليوم جبتلكم ملفات مهمة',
     ...
     likesCount: 13,
     commentsCount: 2,
     sharesCount: 1,reactionUsers:[
       ReactionUser(userId: '1', name: 'حسين غباين', avatarUrl: 'https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?semt=ais_hybrid', reactionType: ReactionType.insightful),
       ReactionUser(userId: '1', name: 'حسين غباين', avatarUrl: 'https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?semt=ais_hybrid', reactionType: ReactionType.insightful),
       ReactionUser(userId: '2', name: 'ابراهيم العكلوك', avatarUrl: 'https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?semt=ais_hybrid', reactionType: ReactionType.heart),
     ]
     ),
     PostEntity(
     userId: '3',
     ...
     likesCount: 10,
     commentsCount: 21,
     sharesCount: 0,reactionUsers:[
       ReactionUser(userId: '1', name: 'حسين غباين', avatarUrl: 'https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?semt=ais_hybrid', reactionType: ReactionType.heart),
       ReactionUser(userId: '2', name: 'ابراهيم العكلوك', avatarUrl: 'https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?semt=ais_hybrid', reactionType: ReactionType.heart)
     ]
     ),
      PostEntity(
